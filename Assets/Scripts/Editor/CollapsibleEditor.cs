    ...
    public override void OnInspectorGUI()
{
    ...
    SerializedProperty isBrokenProp = serializedObject.FindProperty("isBroken");
    SerializedProperty onCollapseEventProp = serializedObject.FindProperty("OnCollapse");
    ...
    EditorGUILayout.PropertyField(isBrokenProp);

    // Секция событий
    EditorGUILayout.Space();
    EditorGUILayout.LabelField("События", EditorStyles.boldLabel);
    EditorGUILayout.PropertyField(onCollapseEventProp);
